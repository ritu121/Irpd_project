          ...
          <div className="grid m-2 p-5">
            ...
            <div className="grid grid-cols-2 gap-2 ">
              <div className="w-50">
                ...
                <select
                  className="form-control block text-base sm:text-sm w-full px-3 shadow-md text-base py-1.5  
            ...
            <div>
              ...
              >
                ...
                {jobs.map((option, index) => (
                  <option key={index} value={option.job_id}>
                    {option.job_title}
                  </option>
                ))}
              </select>
                ...
                <div className="border-2  p-5 mt-2">
                  <div className="flex justify-between">
                    ...
                    {prevExperience.length !== 1 && (
                      <button
                        className="shadow-md rounded-lg text-white bg-[#152C4F] w-50 px-6 py-2.5 
            ...
            <div className="flex justify-center mt-3">
              <div className="w-5/12">
                {" "}
                <Button title={"Add Candidate"} type="submit"></Button>
              </div>
            </div>
            <div className="flex justify-center mt-3">
              <div className="w-5/12" onClick={handleCancelClick}>
                {" "}
